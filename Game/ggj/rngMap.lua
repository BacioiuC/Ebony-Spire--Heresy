...
function rngMap:init( )
	...
	self._enemyLevelRatio[1] = 10
	self._enemyLevelRatio[2] = 5
	self._enemyLevelRatio[3] = 15
	self._enemyLevelRatio[4] = 9
	self._enemyLevelRatio[5] = 0
	self._enemyLevelRatio[6] = 5
	self._enemyLevelRatio[7] = 11
	self._enemyLevelRatio[8] = 4
	self._enemyLevelRatio[9] = 0
...
function rngMap:generateFromTMXV2(cinematicMode)
	self._mapWidth = 30
	self._mapHeight = 30
	local map ={}
...
function rngMap:returnEmptyLocations(_boolInfiniteMode)
	...
	if _boolInfiniteMode == true then
		local occupiedLocations = {}
		local px, py = player:returnPosition( )
		for i = 1, self._emptyCellTable do
			local distance = math.distance(px, py, self._emptyCellTable[i]._x, self._emptyCellTable[i]._y)
			...
			if distance > 10 and boolOccupied == false then
				resTable._x = self._emptyCellTable[i]._x
				resTable._y = self._emptyCellTable[i].__y
